...
namespace OculusSampleFramework
{
	public class HandsManager : MonoBehaviour
	{
		...
		public SkinnedMeshRenderer LeftMeshRenderer
		{
			get { return _leftMeshRenderer; }
		}
		public SkinnedMeshRenderer RightMeshRenderer
		{
			get { return _rightMeshRenderer; }
		}
		...
		private void Update()
		{
			...
			if (_rightMeshRenderer != null) _rightMeshRenderer.sharedMaterial.SetFloat(HandAlphaId, _currentHandAlpha);
			if (_leftMeshRenderer != null) _leftMeshRenderer.sharedMaterial.SetFloat(HandAlphaId, _currentHandAlpha);
		}
